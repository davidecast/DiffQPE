...
configuration_1 = [0, 1, 0, 1, 0, 0, 0, 0]
#configuration_2 = [1, 0, 0, 1, 0, 0, 0, 0]
...
energy_ini = function4(geometry, 0.010, 4)
energy.append(energy_ini)

temperature = np.asarray([0.010], requires_grad = False)
...
np.save("formald_bfgs_triplet_13_qubits_energy", energy)

np.save("formald_bfgs_triplet_13_qubits_geometry", geometries)

np.save("formald_bfgs_triplet_13_qubits_forces", F)

np.save("formald_bfgs_triplet_13_qubits_probabilities", probabilities)
